...
<sub>The figure above is generated by <a href="docs/map_figure.py">docs/map_figure.py</a> — <code>pip install git+https://github.com/GuoCheng24/sciglyph</code> and run it to reproduce <code>docs/map.png</code> byte for byte.</sub>
